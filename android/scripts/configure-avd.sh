...
ensure_kv "hw.cpu.ncore" "${AVD_CPU_CORES}"
...
echo "Updated ${CONFIG_PATH} (perf mode: host GPU, ${AVD_RAM_MB}MB RAM, ${AVD_CPU_CORES} cores, no device frame; hardware keyboard enabled)"
