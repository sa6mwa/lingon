...
class BackgroundWallForegroundService : Service() {
    ...
    private suspend fun runPollLoop() {
        ...
        while (serviceScope.isActive) {
            val appInForeground = app.isAppInForeground()
            if (!shouldPollBackgroundWall(appInForeground = appInForeground)) {
                delay(foregroundRecheckIntervalMs)
                continue
            }
    ...
    internal companion object {
        ...
        private const val foregroundRecheckIntervalMs = 1_000L
