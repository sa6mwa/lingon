...
By default the integration runner stops any emulator it started and resets app
state between individual test cases. Override with:

```bash
LINGON_IT_KEEP_EMULATOR=1 make integration-test
