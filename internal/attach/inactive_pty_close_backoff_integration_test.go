...
func TestAttachDoesNotHammerAPIWhenInactivePTYCloses(t *testing.T) {
	...
	if deltaSessions > 3 || deltaWS > 3 {
		t.Fatalf("unexpected request churn after inactive pty close: sessions=%d ws=%d", deltaSessions, deltaWS)
	}
	_ = host
}
