...
// ShareTokenStatus filters share tokens returned by the relay.
type ShareTokenStatus string

// Share token status filters.
const (
	ShareTokenStatusValid   ShareTokenStatus = "valid"
	ShareTokenStatusRevoked ShareTokenStatus = "revoked"
