...
const file_internal_protocolpb_relay_proto_rawDesc = "" +
	"\n" +
	"\x1finternal/protocolpb/relay.proto\x12\x0flingon.protocol\"\xfc\x06\n" +
	"\x05Frame\x12\x1d\n" +
	"\n" +
	...
	"\x16wall_inactivity_status\x18\x18 \x01(\v2%.lingon.protocol.WallInactivityStatusH\x00R\x14wallInactivityStatusB\t\n" +
	"\apayload\"\xad\x01\n" +
	"\x05Hello\x12\x1b\n" +
