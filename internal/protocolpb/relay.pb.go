...
func (x *Frame) GetWallInactivityStatus() *WallInactivityStatus {
	if x != nil {
		if x, ok := x.Payload.(*Frame_WallInactivityStatus); ok {
			return x.WallInactivityStatus
		}
	}
	return nil
}

func (x *Frame) GetActivity() *Activity {
	if x != nil {
		if x, ok := x.Payload.(*Frame_Activity); ok {
			return x.Activity
		}
	}
	return nil
...
type Frame_WallInactivityStatus struct {
	WallInactivityStatus *WallInactivityStatus `protobuf:"bytes,24,opt,name=wall_inactivity_status,json=wallInactivityStatus,proto3,oneof"`
}

type Frame_Activity struct {
	Activity *Activity `protobuf:"bytes,25,opt,name=activity,proto3,oneof"`
}
...
func (*Frame_WallInactivityStatus) isFrame_Payload() {}

func (*Frame_Activity) isFrame_Payload() {}
...
type WallInactivityStatus struct {
	...
	InactiveAfter string                 `protobuf:"bytes,2,opt,name=inactive_after,json=inactiveAfter,proto3" json:"inactive_after,omitempty"`
	Error         string                 `protobuf:"bytes,3,opt,name=error,proto3" json:"error,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *WallInactivityStatus) Reset() {
	*x = WallInactivityStatus{}
	mi := &file_internal_protocolpb_relay_proto_msgTypes[18]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *WallInactivityStatus) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*WallInactivityStatus) ProtoMessage() {}

func (x *WallInactivityStatus) ProtoReflect() protoreflect.Message {
	mi := &file_internal_protocolpb_relay_proto_msgTypes[18]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use WallInactivityStatus.ProtoReflect.Descriptor instead.
func (*WallInactivityStatus) Descriptor() ([]byte, []int) {
	return file_internal_protocolpb_relay_proto_rawDescGZIP(), []int{18}
}

func (x *WallInactivityStatus) GetEnabled() bool {
	if x != nil {
		return x.Enabled
	}
	return false
...
func (x *WallInactivityStatus) GetInactiveAfter() string {
	if x != nil {
		return x.InactiveAfter
	}
	return ""
}

func (x *WallInactivityStatus) GetError() string {
	if x != nil {
		return x.Error
	}
	return ""
...
func (x *SessionClosed) Reset() {
	*x = SessionClosed{}
	mi := &file_internal_protocolpb_relay_proto_msgTypes[19]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SessionClosed) Descriptor() ([]byte, []int) {
	return file_internal_protocolpb_relay_proto_rawDescGZIP(), []int{19}
}
...
func (x *Activity) Reset() {
	*x = Activity{}
	mi := &file_internal_protocolpb_relay_proto_msgTypes[20]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Activity) Descriptor() ([]byte, []int) {
	return file_internal_protocolpb_relay_proto_rawDescGZIP(), []int{20}
}
...
const file_internal_protocolpb_relay_proto_rawDesc = "" +
	"\n" +
	"\x1finternal/protocolpb/relay.proto\x12\x0flingon.protocol\"\xb5\a\n" +
	"\x05Frame\x12\x1d\n" +
	"\n" +
...
var file_internal_protocolpb_relay_proto_msgTypes = make([]protoimpl.MessageInfo, 21)
var file_internal_protocolpb_relay_proto_goTypes = []any{
	...
	(*Activity)(nil),             // 22: lingon.protocol.Activity
}
var file_internal_protocolpb_relay_proto_depIdxs = []int32{
	...
	22, // 15: lingon.protocol.Frame.activity:type_name -> lingon.protocol.Activity
	16, // 16: lingon.protocol.Snapshot.cursor:type_name -> lingon.protocol.Cursor
	6,  // 17: lingon.protocol.Diff.diff_rows:type_name -> lingon.protocol.DiffRow
	16, // 18: lingon.protocol.Diff.cursor:type_name -> lingon.protocol.Cursor
	8,  // 19: lingon.protocol.Scrollback.rows:type_name -> lingon.protocol.ScrollbackRow
	0,  // 20: lingon.protocol.Command.kind:type_name -> lingon.protocol.CommandKind
	18, // 21: lingon.protocol.Sessions.sessions:type_name -> lingon.protocol.SessionInfo
	1,  // 22: lingon.protocol.Wall.kind:type_name -> lingon.protocol.WallKind
...
func file_internal_protocolpb_relay_proto_init() {
	...
	file_internal_protocolpb_relay_proto_msgTypes[0].OneofWrappers = []any{
		...
		(*Frame_Command)(nil),
		(*Frame_WallInactivityStatus)(nil),
		(*Frame_Activity)(nil),
	}
	type x struct{}
