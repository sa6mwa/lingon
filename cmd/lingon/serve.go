...
func NewServeCommand(loader *lingon.Loader) *cobra.Command {
	...
	v.SetDefault("server.replay_history_bytes", lingon.DefaultReplayHistoryBytes)
	...
	flags.Int("replay-history-bytes", lingon.DefaultReplayHistoryBytes, "max replay history bytes to retain for reconnecting clients")
	...
	bind("server.replay_history_bytes", "replay-history-bytes")
